      ...
      return (
          <nav className="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div className="container">
              <Link activeClass="navbar-shrink" className="navbar-brand js-scroll-trigger" to="page-top" spy={true} smooth={true} offset={50} duration={500} onSetActive={this.handleDelActive}>Hayeon Baek</Link>
