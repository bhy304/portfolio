                ...
                <Description>
                    <Flex>
                        ...
                        <div className="mt">
                            ...
                            Slack, Trello, Discord, Notion 등의 협업 툴을 프로젝트에 적용하며 협업 툴 활용능력도 쌓을 수 있었습니다. 팀원들과의 자발적인 스터디를 통해 기술과 지식을 함께 나누며 정보 공유 가치의 중요성도 느낄 수 있었습니다. 
                            <br />
                            <br />
                            좋은 개발자는 '끊임없이 공부하는 개발자'라는 생각으로 개발 서적과 온라인강의 등을 통한 학습, 사이드 프로젝트를 진행하며 자기 개발에도 손을 놓지 않고 있습니다.
                            <br />
                            <br />
                            {/* 최근 관심사 */}
                            현재 React.js를 활용한 웹 개발과 Git을 통한 협업 및 프로젝트 관리, 그리고 Python 업무 자동화에 관심이 많습니다.
                        </div>
